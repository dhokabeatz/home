...
export class PaymentsController {
  ...
  async initializePayment(
    ...
    return this.paymentsService.purchaseProject(initializePaymentDto.projectId, userInfo);
  }
  ...
  async checkProjectAccess(
    ...
    const result = await this.paymentsService.checkProjectAccess(projectId, email);
    return result;
  }
