...
export class UsersController {
  ...
  @ApiResponse({ status: 200, description: 'Portfolio statistics updated successfully' })
  async updatePortfolioStats(@Request() req, @Body() updatePortfolioStatsDto: UpdatePortfolioStatsDto) {
  ...
  @ApiConsumes('multipart/form-data')
  @ApiResponse({ status: 200, description: 'About content uploaded successfully' })
  async uploadAboutContent(
    @Request() req,
    @Param('contentType') contentType: 'heading' | 'subtitle' | 'paragraph1' | 'paragraph2',
    @UploadedFile(
      new ParseFilePipe({
        validators: [
  ...
  @ApiConsumes('multipart/form-data')
  @ApiResponse({ status: 200, description: 'About image uploaded successfully' })
